                  ...
                  <div key={i} className='-mx-4 md:px-4'>
                    ...
                    >
                      ...
                      <div className='w-full md:w-1/2 lg:w-full'>
                        <h3 className='text-2xl left-9 mx-4 md:mx-0 mt-2 md:mt-0 lg:mt-2 mb-0 md:mb-2 text-[var(--dark)]  group-hover:text-[var(--text-primary)]  dark:text-white  font-semibold'>
                          {post_title}
                        </h3>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <h3 className='text-lg text-[var(--dark)]    dark:text-white  group-hover:text-[var(--text-primary)]  line-clamp-2 font-bold'>
                          {post_title}
                        </h3>
                        <span className='text-[var(--gray-2)] dark:text-[var(--gray-3)] mt-2 text-base line-clamp-2'>
                          {excerpt || stitle}
