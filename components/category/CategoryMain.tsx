            ...
            <div className="container px-4 mx-auto">
                <div className="border-[var(--border-color)] dark:border-[var(--border-dark)] border-b-[2px] mb-3">
                    ...
                    <div className="flex pt-6">
                        {data.subcategories.map( (subCategorySlug: string) => <div key={subCategorySlug} className="pr-10"><FontAwesomeIcon icon={faDotCircle} className="text-xs mr-1"/><Link href={`/${param.categoryName}/${subCategorySlug}`}>{subCategorySlug}</Link></div>)}
                    </div>
